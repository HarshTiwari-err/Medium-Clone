  ...
  return (
    <nav className="navbar">
      ...
      <div className="relative">
        <svg
          className="input-icon w-[24px] h-[24px] "
          viewBox="0 0 24 24"
          fill="none"
        >
          <path
      ...
      <div className="flex flex-1 gap-4 justify-end items-center">
        <div className="flex cursor-pointer gap-2 items-center opacity-50 mr-4">
          <svg
        ...
        <div className="md:flex hidden gap-2 mr-2">
          <div className="btn-dark">Sign up</div>
          <div className="btn-light">Sign in</div>
        </div>
          ...
          {toggle && (
            <div className="absolute shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] bg-white  w-[264px] rounded-xl  top-[54px] right-[-8px] z-1">
              <div className="w-full px-6 pt-8 pb-6 flex flex-col items-center text-center font-bold">
                ...
                <div className="btn-dark mt-6 w-full ">Sign Up</div>
                <div className="btn-light mt-4 w-full">Sign In</div>
              </div>
            </div>
          )}
        </div>
